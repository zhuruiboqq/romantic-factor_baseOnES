<a href="http://zhuruiboqq.github.io/es/" target="_blank">项目首页</a>
|
...
* <a href="https://github.com/zhuruiboqq/es/blob/master/src/support/img/1.PNG?raw=true" target="_blank">点击查看1</a>
* <a href="https://github.com/zhuruiboqq/es/blob/master/src/support/img/2.PNG?raw=true" target="_blank">点击查看2</a>
* <a href="https://github.com/zhuruiboqq/es/blob/master/src/support/img/3.PNG?raw=true" target="_blank">点击查看3</a>


##CI status
<a href="https://travis-ci.org/zhuruiboqq/es"><img src="https://travis-ci.org/zhuruiboqq/es.png"/></a>
...
* jetty.bat 启动web应用 默认端口9080 可以到es/web/pom.xml下修改（servlet 2.5即可）http://localhost:9080/es-web/login
* 系统默认帐户是admin/123456
