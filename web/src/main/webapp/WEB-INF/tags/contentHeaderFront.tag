...
<link rel="icon" href="${ctx}/static/images/logo2.png">
<link rel="shortcut icon" href="${ctx}/static/images/logo2.png">
<link href="${ctx}/static/css/front/romantic_factor.css" rel='stylesheet' type='text/css' />
<script src="${ctx}/static/js/front/jquery-1.7.2.min.js" type="text/javascript"></script>
<script src="${ctx}/static/js/front/custom.modernizr.js"></script>
</head>
