...
<div class="panel">
	...
	<ul class="nav nav-tabs">
		<shiro:hasPermission name="basedata:artistWorks:create">
			<c:if test="${op eq '新增'}">
				<li ${op eq '新增' ? 'class="active"' : ''}><a href="${ctx}/basedata/artistWorks/create?BackURL=<es:BackURL/>"> <i class="icon-file-alt"></i> 新增
				</a></li>
			</c:if>
		</shiro:hasPermission>
		...
		<c:if test="${not empty m.id}">
			<li ${op eq '查看' ? 'class="active"' : ''}><a href="${ctx}/basedata/artistWorks/${m.id}?BackURL=<es:BackURL/>"> <i class="icon-eye-open"></i> 查看
			</a></li>
			<shiro:hasPermission name="basedata:artistWorks:delete">
				<li ${op eq '删除' ? 'class="active"' : ''}><a href="${ctx}/basedata/artistWorks/${m.id}/delete?BackURL=<es:BackURL/>"> <i class="icon-trash"></i>
						删除
				</a></li>
			</shiro:hasPermission>
		</c:if>
